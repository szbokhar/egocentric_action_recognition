...
if __name__ == '__main__':
    ...
    if args.object:
        object_feature_folder = os.path.join(feature_folder, 'object_fc7')
        mkdir_safe(object_feature_folder)
    else:
        motion_feature_folder = os.path.join(feature_folder, 'motion_fc7')
    ...
    if args.object:
        for i, folder in enumerate(object_folders):
            ...
            features = sample_object_features(net, 'fc7_gtea', Imean, images)
        ...
        for i, folder in enumerate(flow_folders):
            ...
            features = sample_motion_features(net, 'fc7', x_images, y_images)
