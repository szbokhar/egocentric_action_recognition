...
results_file = 'Ahmad_Turkey_results.pkl'
...
for img in images:
	...
	#predict_confidence.append(score[index])
	predict_confidence.append(score[6])
	label_actions.append(results[img][1])

predict_actions = predict_actions[1000:1300]
predict_confidence = predict_confidence[1000:1300]
label_actions = label_actions[1000:1300]
