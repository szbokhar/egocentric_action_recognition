...
args.source = 'PLUS44_data/RAHUL_train15.txt'
args.model_prefix = 'PLUS44_model15/PLUS44_RAHUL_T{}'.format(args.data_type)
...
solver.restore('PLUS44_model15/PLUS44_RAHUL_T2_iter_2000.solverstate')
