...
input_dir = '/home/minghuam/data/GTEA_gaze_plus/RAW/images44'
output_dir = 'PLUS44_output/{}_prob'.format(subject)
...
for folder in folders:
    ...
    for img in images:
        ...
        cv2.imshow("ret", Iret)
        cv2.imwrite(os.path.join(output_dir, folder, os.path.basename(img)), Iret)
