#!/bin/bash
python verb_solve.py verb_train_plus44.prototxt PLUS44H_data/AHMAD_train.txt PLUS44H_model/VERB_PLUS44H_AHMAD 0.0005 3000 1 2>&1 | tee log/verb_solve_plus44h_ahmad.log
