#!/bin/bash
python verb_solve.py verb_train_plus44.prototxt PLUS44H10MH_data/AHMAD_train.txt PLUS44H10MH_model/VERB_PLUS44H10MH_AHMAD 0.0005 3000 2 2>&1 | tee log/verb_solve_plus44h10mh_ahmad.log
